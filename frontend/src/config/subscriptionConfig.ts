...
export const TIER_CONFIG: Record<SubscriptionTier, TierConfig> = {
  ...
  standard: {
    ...
    borderColor: '#E67E22',
    allowedTabs: ['overview', 'career', 'personality', 'health', 'marriage', 'matching', 'food'],
    dailyChatLimit: 25,
    maxProfiles: 3,
    allowPrashna: false,
    allowBTR: true,
  ...
  pro: {
    ...
    borderColor: '#C89B3C',
    allowedTabs: ['overview', 'career', 'personality', 'health', 'remedies', 'food', 'finance', 'marriage', 'matching', 'spiritual'],
